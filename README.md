...
- `rancher/hardened-csi-node-driver-registrar` — CSI Node Driver Registrar Sidecar

## Building locally

```sh
make build-image-csi-node-driver-registrar # build for the host architecture
...
- the upstream `node-driver-registrar` version (`TAG`), and
